...
| 4 | ICFES — Saber 11 2024-2 | Resultados agregados por sede educativa (GeoPackage) | [datosabiertos.bogota.gov.co]([https://www.icfes.gov.co](https://datosabiertos.bogota.gov.co/dataset/resultados-pruebas-saber-11-bogota-d-c) |
...
| 6 | SED — Tasa de deserción escolar oficial | Deserción por localidad (GeoPackage) | [datosabiertos.bogota.gov.co](https://datosabiertos.bogota.gov.co/dataset/tasa-de-desercion-escolar-en-colegios-oficiales-por-localidad-bogota-d-c) |
| 7 | SED — Tasa de reprobación escolar oficial | Reprobación por localidad (GeoPackage) | [datosabiertos.bogota.gov.co](https://datosabiertos.bogota.gov.co/dataset/tasa-de-reprobacion-escolar-en-colegios-oficiales-por-localidad-bogota-d-c) |
...
También se construyeron variables relacionadas con la disponibilidad relativa de recursos humanos en las sedes educativas. Para ello, se calcularon razones entre el total de estudiantes matriculados en la sede y el número de personas disponibles por rol, es decir, estudiantes por cada integrante del personal educativo. En este grupo se incluyeron la razón de estudiantes por directivo, por docente de aula, por orientador, por líder de apoyo en el aula y por docente de apoyo en el aula. En este caso, valores más altos indican una menor disponibilidad relativa de personal por estudiante. 
